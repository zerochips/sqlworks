...
INSERT INTO book VALUES (5, '피켜교본', '굿스포츠', 8000);
...
SELECT *
FROM book
WHERE publisher = '대한미디어' OR price = 35000;
...
-- 축구에 관한 도서 중 가격이 2000원 이상인 도서를 찾으시오
SELECT *
FROM book
WHERE bookname Like '%축구%'
AND price >= 20000;
